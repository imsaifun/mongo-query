                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link href="/job-details"><a>React Native Web Developer</a></Link>
                                        </h5>
                                    ...
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                                <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">Figma</a></Link>

                                            <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">Adobe XD</a></Link>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link href="/job-details"><a>Digital Marketing Manager</a></Link>
                                        </h5>
                                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">6 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                                <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">SEO</a></Link>

                                            <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">Word</a></Link>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link href="/job-details"><a>Web Designer/Developer</a></Link>
                                        </h5>
                                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">9 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                                <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">HTML</a></Link>

                                            <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">CSS</a></Link>

                                            <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">JS</a></Link>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link href="/job-details"><a>Full Stack Engineer</a></Link>
                                        </h5>
                                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">13 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                                <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">NodeJS</a></Link>

                                            <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">MongoDB</a></Link>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link href="/job-details"><a>Frontend Developer Full time</a></Link>
                                        </h5>
                                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">16 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                                <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">Bootstrap</a></Link>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link href="/job-details"><a>React Native Mobile Developer</a></Link>
                                        </h5>
                                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">30 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                                <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">React</a></Link>

                                            <Link href="/jobs-grid"><a className="btn btn-tags-sm mr-5">NextJS                      </a></Link>
