                        ...
                        <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                            <div className="card-grid-2-image-left"><span className="flash" />
                                ...
                                <div className="right-info">
                                    <Link href="/company-details"><a className="name-job">Quora JSC</a></Link>
                                    <span className="location-small">New York, US</span></div>
                            </div>
                            <div className="card-block-info">
                                <h6>
                                    <Link href="/job-details"><a>Senior System Engineer</a></Link>
                                    </h6>
                                ...
                                <div className="mt-30">
                                    <Link href="/job-details"><a className="btn btn-grey-small mr-5">PHP</a></Link>

                                <Link href="/job-details"><a className="btn btn-grey-small mr-5">Android  </a></Link>
                                ...
                                <div className="card-2-bottom mt-30">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-5 col-5 text-end">
                                            <Link href="/job-details"><a className="btn btn-apply-now">Apply now</a></Link>
                                            </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                            <div className="card-grid-2-image-left"><span className="flash" />
                                ...
                                <div className="right-info">
                                    <Link href="/company-details"><a className="name-job">Dailymotion</a></Link>
                                    <span className="location-small">New York, US</span></div>
                            </div>
                            <div className="card-block-info">
                                <h6>
                                    <Link href="/job-details"><a>Frontend Developer</a></Link>
                                    </h6>
                                ...
                                <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                                <div className="mt-30">
                                    <Link href="/jobs-grid"><a className="btn btn-grey-small mr-5">Typescript</a></Link>

                                <Link href="/jobs-grid"><a className="btn btn-grey-small mr-5">Java</a></Link>
                    ...
                    <SwiperSlide>
                        <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                            <div className="card-grid-2-image-left"><span className="flash" />
                                ...
                                <div className="right-info">
                                    <Link href="/company-details"><a className="name-job">Periscope</a></Link>
                                    <span className="location-small">New York, US</span></div>
                            </div>
                            <div className="card-block-info">
                                <h6>
                                    <Link href="/job-details"><a>Lead Quality Control QA</a></Link>
                                    </h6>
                                <div className="mt-5"><span className="card-briefcase">Full time</span><span className="card-time">6<span> minutes ago</span></span></div>
                                <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                                <div className="mt-30">
                                    <Link href="/job-details"><a className="btn btn-grey-small mr-5">iOS</a></Link>

                                <Link href="/job-details"><a className="btn btn-grey-small mr-5">Laravel</a></Link>

                                <Link href="/job-details"><a className="btn btn-grey-small mr-5">Golang</a></Link>
