                            ...
                            <div className="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                ...
                                <div className="card-block-info">
                                    <div className="tags mb-15">
                                        <Link href="/blog">
                                            <a className="btn btn-tag">News
                                            </a>
                                        </Link>
                                    </div>
                                    <h5>
                                        <Link href="/blog">
                                            <a>21 Job Interview Tips: How To Make a Great Impression
                                            </a>
                                        </Link>
                                    </h5>
                    ...
                    <SwiperSlide><div className="swiper-slide">
                        <div className="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                            ...
                            <div className="card-block-info">
                                <div className="tags mb-15">
                                    <Link href="/blog">
                                        <a className="btn btn-tag">Events
                                        </a>
                                    </Link>
                                </div>
                                <h5>
                                    <Link href="/blog">
                                        <a>39 Strengths and Weaknesses To Discuss in a Job Interview
                                        </a>
                                    </Link>
                                </h5>
                                <p className="mt-10 color-text-paragraph font-sm">Our mission is to create the world&amp;rsquo;s most sustainable healthcare company by creating high-quality healthcare products in iconic, sustainable packaging.</p>
                    ...
                    <SwiperSlide><div className="swiper-slide">
                        <div className="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                            ...
                            <div className="card-block-info">
                                ...
                                <h5>
                                    <Link href="/blog">
                                        <a>Interview Question: Why Dont You Have a Degree?
                                        </a>
                                    </Link>
                                </h5>
